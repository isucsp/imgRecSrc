...
ssheaddec=zeros(ceil(m/r),n);

for i=1:n
    ssheaddec(:,i)= decimate(sshead(:,i),r);
end
    
save ssheaddecEx.mat ssheaddec

n1=2^floor(log2(m))/r;
load('ssheaddecEx.mat');
y=ssheaddec;
...
[y,Phi,Phit,Psi,Psit,OPT,FBP]=loaddata(OPT,y,1625);
fbp.img=FBP(y);
